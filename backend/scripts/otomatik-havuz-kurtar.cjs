...
// Kullanım: node scripts/otomatik-havuz-kurtar.cjs

const mongoose = require('mongoose');
const path = require('path');
const Test = require(path.join(__dirname, '../models/Test.js'));
const TestHavuzu = require(path.join(__dirname, '../models/TestHavuzu.js'));
const Konu = require(path.join(__dirname, '../models/Konu.js'));
const Ders = require(path.join(__dirname, '../models/Ders.js'));
const Sinif = require(path.join(__dirname, '../models/Sinif.js'));
