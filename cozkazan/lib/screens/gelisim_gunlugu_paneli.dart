...
class _GelisimGunluguPaneliState extends State<GelisimGunluguPaneli> {
  ...
  Widget _buildOzetKartlari() {
    final toplamXp = _haftalikVeriler.fold(0, (sum, item) => sum + item['xp']);
    final toplamKitap = _haftalikVeriler.fold(0, (sum, item) => sum + item['kitap']);
    final toplamTest = _haftalikVeriler.fold(0, (sum, item) => sum + item['test']);
